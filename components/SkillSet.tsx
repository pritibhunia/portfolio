...
import { SiKubernetes, SiCss3, SiDotnet, SiPandas, SiPytorch, SiScikitlearn, SiGnubash, SiSqlite, SiStreamlit, SiTerraform, SiYaml } from 'react-icons/si';
...
const skills = [
  ...
  { name: 'Bash', icon: <SiGnubash className={styles.skillIcon} style={{ color: '#FFD500' }} /> },
